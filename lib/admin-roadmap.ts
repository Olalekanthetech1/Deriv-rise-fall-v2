...
export const adminRoadmap: RoadmapSection[] = [
  ...
  { id: 'model-artifacts', title: 'Artifact Integrity & Migration', description: 'Durable production artifact health, lineage verification and controlled migration through the existing ML worker.', status: 'next' },
