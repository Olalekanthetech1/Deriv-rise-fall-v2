...
/**
 * Canonical runtime feature-definition registry.
 *
 * This is the single source of truth for feature keys, ordering and count.
 * Pipeline configuration consumes this registry instead of maintaining a
 * second, independently maintained feature-order list.
 */
export const FEATURE_DEFINITIONS = [
  // Pillar 1: Price Behaviour
  ...
  // Pillar 2: Tick Pressure & Sequencing
  ...
  // Pillar 3: Tick Velocity & Acceleration
  ...
  // Pillar 4: Short / Medium / Macro Volatility
...
export function buildFeatureRecord(context: FeatureContext): EngineeredFeatureRecord {
  ...
  for (const definition of FEATURE_DEFINITIONS) {
    ...
    record[definition.key] = Number.isFinite(value) ? value : 0;
  }
  return record;
}
