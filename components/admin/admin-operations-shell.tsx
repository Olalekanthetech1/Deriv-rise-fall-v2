...
import { Activity, AlertTriangle, ArrowRight, BarChart3, BrainCircuit, CheckCircle2, Database, FlaskConical, Gauge, KeyRound, Lock, LogOut, Network, Radio, RefreshCw, Server, ShieldCheck, TerminalSquare, Wrench } from 'lucide-react';
...
const sections: AdminSection[] = [
  ...
  { id: 'models', title: 'Model Operations', description: 'Registry, validation, promotion, rollback and retraining lifecycle.', status: 'next', icon: BarChart3 },
...
export default function AdminOperationsShell() {
  ...
  const handleLogin = async (event: FormEvent<HTMLFormElement>) => {
    event.preventDefault(); if (!passkey.trim()) { setAuthError('Enter the admin passkey.'); return; }
