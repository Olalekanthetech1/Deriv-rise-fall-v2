...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Delete and audit are executed as one PostgreSQL statement/transaction.
    // The delete only executes when every requested ID is still eligible at execution time.
