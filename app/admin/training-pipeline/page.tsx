...
export default function TrainingPipelinePage() {
  ...
  return <main className="min-h-screen bg-[#05070b] px-4 py-5 text-slate-100 sm:px-6 lg:px-8"><div className="mx-auto max-w-[1500px]">
    ...
    {runningRuns.length>0 && <div className="mb-5 rounded-2xl border border-amber-400/20 bg-amber-400/[0.05] p-4 text-sm text-amber-100"><strong>History reset is locked.</strong> {runningRuns.length} training run{runningRuns.length===1?' is':'s are'} currently running. Let the active training job finish before clearing history.</div>}
