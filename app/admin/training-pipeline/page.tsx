...
export default function TrainingPipelinePage() {
  ...
  async function startSingle() {
    ...
    try {
      ...
      setMessage(`Training run ${data.runId} completed with ${data.completedModels}/${data.totalModels} models completed.`);
      await load();
